...
This repo contains the starter code for the Route Planning project and my solution included.
...
```
git clone https://github.com/ahmedhussien91/CppND-Route-Planning-Project.git --recurse-submodules
```
or with SSH:
```
git clone git@github.com:ahmedhussien91/CppND-Route-Planning-Project.git --recurse-submodules
```
